...
export class FullNameComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.createForm.controls['firstName'].setValue(this.data.firstName);
    this.createForm.controls['lastName'].setValue(this.data.lastName);
  }

  focusOutFunction() {
    this.inputFocusClass = true;
    this.data.firstName = this.createForm.value.firstName;
    this.data.lastName = this.createForm.value.lastName;
    this.sharedData.setDataToTemplateItem('fullName', this.data, this.guid);
  }
  focusFunction() {
