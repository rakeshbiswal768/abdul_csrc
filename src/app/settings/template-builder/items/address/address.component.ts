...
export class AddressComponent implements OnInit {
  ...
  showItem = true;
  guid = '';
  constructor(private formBuilder: FormBuilder, @Inject(forwardRef(() => TempBuilderService)) private tbService: TempBuilderService, private sharedData: SharedDataService) {
  ...
  focusOutFunction() {
    ...
    this.sharedData.setDataToTemplateItem('address', this.createForm.value);
  }
  focusFunction() {
